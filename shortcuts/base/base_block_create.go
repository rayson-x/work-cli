...
var BaseBaseBlockCreate = common.Shortcut{
	...
	Tips: []string{
		"Example: work-cli base +base-block-create --base-token <base_token> --type folder --name \"Project Docs\"",
		"Example: work-cli base +base-block-create --base-token <base_token> --type table --name \"Tasks\"",
		"Example: work-cli base +base-block-create --base-token <base_token> --type docx --name \"Spec\" --parent-id <folder_block_id>",
		"Example: work-cli base +base-block-create --base-token <base_token> --type dashboard --name \"Metrics\"",
		"Example: work-cli base +base-block-create --base-token <base_token> --type workflow --name \"Approval Flow\"",
