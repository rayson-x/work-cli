...
var BaseBaseBlockMove = common.Shortcut{
	...
	Tips: []string{
		"Example: work-cli base +base-block-move --base-token <base_token> --block-id <block_id> --parent-id <folder_block_id>",
		"Example: work-cli base +base-block-move --base-token <base_token> --block-id <block_id> --after-id <sibling_block_id>",
		"Example: work-cli base +base-block-move --base-token <base_token> --block-id <block_id> --before-id <sibling_block_id>",
		"Example: work-cli base +base-block-move --base-token <base_token> --block-id <block_id>",
