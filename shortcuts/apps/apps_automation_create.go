...
var AppsAutomationCreate = common.Shortcut{
	...
	Risk:        "write",
	Tips: []string{
		"Example: work-cli apps +automation-create --app-id <id> --name daily --trigger-type cron --cron '0 9 * * *'",
		"Example: work-cli apps +automation-create --app-id <id> --name onUpd --trigger-type record-change --table <tbl> --event UPDATE",
		"Example: work-cli apps +automation-create --app-id <id> --name hook --trigger-type webhook",
		"Example: work-cli apps +automation-create --app-id <id> --name apv --trigger-type feishu-approval --event-type approval_instance --instance-status APPROVED",
	},
