...
var AppsAutomationUpdate = common.Shortcut{
	...
	Tips: []string{
		"Example: work-cli apps +automation-update --app-id <id> --name t1 --trigger-type cron --cron '0 10 * * *' --yes",
		"Example: work-cli apps +automation-update --app-id <id> --name rc1 --trigger-type record-change --table <tbl> --event UPDATE --fields '[\"fld1\"]' --yes",
		"Example: work-cli apps +automation-update --app-id <id> --name apv --trigger-type feishu-approval --event-type approval_instance --instance-status APPROVED --yes",
		"Example: work-cli apps +automation-update --app-id <id> --name wh1 --reset-url --app-env preview --yes",
		"Example: work-cli apps +automation-update --app-id <id> --name wh1 --enable-token --yes",
		"Example: work-cli apps +automation-update --app-id <id> --name wh1 --white-ip-list '[\"1.1.1.1\"]' --yes",
	},
