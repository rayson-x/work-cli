...
This skill maps to shortcut: `work-cli im +feed-shortcut-create`. Underlying API: `POST /open-apis/im/v2/feed_shortcuts`.
...
work-cli im +feed-shortcut-create --as user --chat-id oc_a,oc_b,oc_c
work-cli im +feed-shortcut-create --as user --chat-id oc_a --chat-id oc_b

# Append at the bottom of the shortcut list instead of the top
work-cli im +feed-shortcut-create --as user --chat-id oc_xxx --tail

# Preview the request without sending
work-cli im +feed-shortcut-create --as user --chat-id oc_xxx --dry-run
```
