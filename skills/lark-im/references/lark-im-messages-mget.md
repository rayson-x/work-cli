...
This skill maps to the shortcut: `work-cli im +messages-mget` (internally calls `GET /open-apis/im/v1/messages/mget`).
...
work-cli im +messages-mget --message-ids "om_aaa,om_bbb,om_ccc"

# JSON output
work-cli im +messages-mget --message-ids "om_aaa,om_bbb" --format json

# Preview the request without executing it
work-cli im +messages-mget --message-ids "om_aaa" --dry-run
```
...
```bash
work-cli im +messages-mget --message-ids om_xxx --format json
```
...
work-cli im +messages-mget --message-ids "om_aaa,om_bbb"
```
