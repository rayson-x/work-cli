...
work-cli schema drive.file.comments.create_v2

work-cli drive file.comments create_v2 \
...
- 如果需要更底层的控制，仍可改用 `work-cli schema drive.file.comments.create_v2` + `work-cli drive file.comments create_v2`。
