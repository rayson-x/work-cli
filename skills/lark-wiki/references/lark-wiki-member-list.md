...
```bash
# Default: single page
work-cli wiki +member-list --space-id <space_id>

# Walk every page (capped by --page-limit, default 10)
work-cli wiki +member-list --space-id <space_id> --page-all

# Walk every page, no cap
work-cli wiki +member-list --space-id <space_id> --page-all --page-limit 0

# Resume from a specific cursor (single-page fetch regardless of --page-all)
work-cli wiki +member-list --space-id <space_id> --page-token <TOKEN>

# Personal library
work-cli wiki +member-list --space-id my_library --as user

# Pretty / table / csv / ndjson output
work-cli wiki +member-list --space-id <space_id> --format pretty
work-cli wiki +member-list --space-id <space_id> --format table
```
