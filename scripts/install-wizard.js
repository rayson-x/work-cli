...
const messages = {
  zh: {
    ...
    step3:          "正在配置应用...",
    step3NotFound:  "未找到 work-cli，终止",
    step3Found:     "发现已配置应用 (App ID: %s)，继续使用？",
    step3Skip:      "跳过应用配置",
    step3Done:      "应用已配置",
    step3Fail:      "应用配置失败。运行以下命令重试: work-cli config init --new",
    step4:          "授权",
    step4NotFound:  "未找到 work-cli，跳过授权",
    step4Confirm:   "是否允许 AI 访问你个人的消息、文档、日历等飞书 / Lark 数据，并以你的名义执行操作？",
    step4Skip:      "跳过授权。后续运行 work-cli auth login 完成授权",
    step4Done:      "授权完成",
    step4Fail:      "授权失败。运行以下命令重试: work-cli auth login",
  ...
  en: {
    ...
    step3NotFound:  "work-cli not found. Aborting",
    step3Found:     "Found existing app (App ID: %s). Use this app?",
    step3Skip:      "Skipped app configuration",
    step3Done:      "App configured",
    step3Fail:      "Failed to configure app. Run manually: work-cli config init --new",
    step4:          "Authorization",
    step4NotFound:  "work-cli not found. Skipping authorization",
    ...
    step4Skip:      "Skipped. Run work-cli auth login to authorize later",
    step4Done:      "Authorization complete",
    step4Fail:      "Failed to authorize. Run work-cli auth login to retry",
